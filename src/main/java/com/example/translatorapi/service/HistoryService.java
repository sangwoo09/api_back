...
import com.example.translatorapi.dto.HistoryDto;
...
public class HistoryService {
    ...
    public String translation(HistoryDto dto){

        String clientId = "__VJvgxqFjW_z94Xaeq8";//애플리케이션 클라이언트 아이디값";
        String clientSecret = "493weg3M3R";//애플리케이션 클라이언트 시크릿값";

        String apiURL = "https://openapi.naver.com/v1/papago/n2mt";
        String text;
        try {
            text = URLEncoder.encode(dto.getSearchWord(), "UTF-8");
